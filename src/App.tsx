  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const [usersRes, templatesRes, logsRes, healthRes] = await Promise.all([
        ...
        axios
          .get("/api/health")
          .catch(() => ({ data: { mongodb: "disconnected" } })),
      ]);
      ...
      <header className="border-b bg-white sticky top-0 z-20">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg sm:text-xl font-bold tracking-tight truncate max-w-[120px] sm:max-w-none">
              InstaSmart CRM
            </h1>
          </div>
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-1 sm:gap-2 pl-2 sm:pl-4 border-l">
              ...
              <button
                ...
                className="p-1.5 cursor-pointer sm:p-2 hover:bg-red-50 hover:text-red-600 rounded-full transition-colors"
                title="Logout"
              >
                <LogOut size={18} />
              </button>
          ...
          <div className="max-w-7xl mx-auto flex items-center gap-3 text-red-800 text-sm font-medium">
            ...
            <p>
              ...
              <span className="font-normal ml-1">
                Please check your MongoDB URI in the Secrets panel and ensure
        ...
        <Tabs defaultValue="users" className="space-y-4 sm:space-y-6">
          <div className="overflow-x-auto pb-2 -mx-2 px-2 sm:mx-0 sm:px-0 scrollbar-hide">
            <TabsList className="bg-white border p-1 h-auto flex-nowrap sm:flex-wrap gap-1 w-max sm:w-full">
              <TabsTrigger
                value="users"
                className="gap-2 px-3 sm:px-4 py-2 transition-all hover:bg-zinc-50 data-[state=active]:shadow-sm cursor-pointer whitespace-nowrap"
              >
                <Users size={16} />{" "}
